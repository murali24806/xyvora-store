...
const CyberneticGridShader = () => {
  ...
  useEffect(() => {
    ...
    // Cap pixel ratio to 1.5 to prevent massive lag on high DPI screens
    ...
    // Use ResizeObserver for perfect responsive scaling
    const resizeObserver = new ResizeObserver(() => onResize());
    resizeObserver.observe(container);
    
    // Also set canvas to block to remove gaps
