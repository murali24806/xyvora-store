  ...
  return (
    <div className="min-h-[80vh] flex items-center justify-center bg-bg px-5 py-20">
      <div className="max-w-md w-full bg-surface p-10 rounded-xl shadow-xl">
        <h2 className="font-display text-4xl mb-6 text-center">Welcome Back</h2>
        ...
        <p className="mt-8 text-center text-sm opacity-60">
          Don't have an account? <Link to="/register" className="font-bold hover:text-accent underline underline-offset-4">Sign Up</Link>
        </p>
      </div>
    </div>
  );
